package com.example.custom_cach_player;// Copyright 2017 The Chromium Authors. All rights reserved.
...
import com.example.custom_cach_player.VideoPlayer;
...
public class CustomCachPlayerPlugin implements MethodCallHandler, FlutterPlugin {
  ...
  public CustomCachPlayerPlugin() {}

  private CustomCachPlayerPlugin(Registrar registrar) {
    this.flutterState =
            new FlutterState(
                    registrar.context(),
                    registrar.messenger(),
  ...
  public static void registerWith(Registrar registrar) {
    final CustomCachPlayerPlugin plugin = new CustomCachPlayerPlugin(registrar);
  ...
  private static final class FlutterState {
    ...
    void startListening(CustomCachPlayerPlugin methodCallHandler) {
